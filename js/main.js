...
const milestonesData = [
    ...
    { date: '2026年5月17日', cn: '首套个人收藏集发售 ✨<br><span class="timeline-detail">晚七点，正式发售B站个人首套收藏集——《爱就一个紫》。</span>', jp: '初の個人コレクションカード発売 ✨<br><span class="timeline-detail">夜19時より、bilibiliにて初の個人コレクションカード『愛就一個紫』が正式に発売。</span>' }
];
