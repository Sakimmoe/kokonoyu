...
    { date: '2026年4月20日', cn: '中国行前夕 🇨🇳<br><span class="timeline-detail">紫老师来中国工作旅游前的最后一次直播。</span>', jp: '中国旅行前夜 🇨🇳<br><span class="timeline-detail">紫先生が中国へ仕事と旅行に行く前の最後の配信。</span>' }
];
...
        title_personal: "个人相关", 
        val_personal: "<ul class='info-list'><li><strong>啊加嘛似嘛似：</strong>紫老师常用“啊加嘛似嘛似”表达感谢。</li><li><strong>病弱：</strong>紫老师大约一至两个月会有身体不佳的情况，通常是发烧。目前带病直播几乎是常态。</li><li><strong>简称：</strong>紫老师全名 ここのえゆかり ⇒ こ这个のゆ ⇒ のゆ ⇒ ゆ。</li><li><strong>整活大师：</strong>熟悉本土各种梗，常整得一手好活，可怕的吸收能力。</li><li><strong>天哨星：</strong>紫老师直播吹得一手好口哨，能熟练吹出《好汉歌》等，被赐号天哨星。</li><li><strong>理工男气质：</strong>紫老师礼貌、努力、懂事，做事一板一眼。</li></ul>",
        title_meme: "相关梗", 
        val_meme: "<ul class='info-list'><li><strong>秦始皇/兵马俑：</strong>阿紫的粉丝玩此梗时便自称为兵马俑。</li><li><strong>紫细胞：</strong>DD行为被抓时，粉丝自称推其他人都是细胞分裂。</li><li><strong>平和族/变态族：</strong>粉丝名称平和族。经常hentai发言的被称为变态族。</li><li><strong>男孩紫：</strong>出现于反怼对方说自己是男孩子。DD狂喜。</li><li><strong>×重紫：</strong>直播间当前人气排名是第几名就是几重紫。</li></ul>",
        btn_back: "← 返回上一页",
        site_p1: "你好！欢迎来到这里。这是一个由粉丝用爱发电、自发搭建的<strong>非官方个人主页</strong>。", 
        site_h1: "搭建初衷", 
        site_p2: "我是2026年1月13日开始关注紫老师的，觉得紫老师是一个对工作很认真、很负责的人，对粉丝也很用心、很真诚。所以搭建了这个主页。", 
        site_h2: "内容来源与建议", 
        site_p3: "本站部分内容资料摘自萌娘百科以及九重紫的B站个人空间。", 
        site_box: "<strong>⚠️ 版权与免责声明</strong><br><br>1. 本网站内所使用的<strong>所有美术素材、图片、Logo、背景故事及设定等内容，版权均归主播 九重紫 及其合作画师所有。</strong><br>2. 本站仅作粉丝安利与导航整理用途，没有任何商业盈利目的。"
    },
    jp: {
...
        title_activity: "配信内容", 
        val_activity: "<p>基本はゲーム配信と杂谈、たまに歌枠やお絵描き。</p><p>ゲームはRPGを中心に、様々なジャンルに挑戦する。</p><p>ゲームスキルは低めで、殺戮、犯罪、騙し合いのあるゲームは苦手。特にFPSは苦手で3D酔いしやすい。</p><p>以前は字幕組がなく、自ら動画制作やネタ作りを行っていた（現在は公式字幕組が設立されている）。</p>",
        title_personal: "パーソナル情報", 
        val_personal: "<ul class='info-list'><li><strong>あじゃますます：</strong>感謝を伝える際によく使う言葉。</li><li><strong>病弱：</strong>1〜2ヶ月に一度体調を崩し、よく熱を出す。</li><li><strong>略称：</strong>ここのえゆかり ⇒ ここのゆ ⇒ のゆ ⇒ ゆ。</li><li><strong>ネタ職人：</strong>中国のネットミームに精通しており、吸収力が凄まじい。</li><li><strong>天哨星：</strong>配信で口笛を吹くのが上手く、「天哨星」というあだ名が付けられた。</li><li><strong>理系男子気質：</strong>礼儀正しく、努力家で物事をきっちりこなす一面がある。</li></ul>",
        title_meme: "関連ミーム", 
        val_meme: "<ul class='info-list'><li><strong>始皇帝/兵马俑：</strong>ファンが兵马俑を自称するように。</li><li><strong>紫細胞：</strong>DD行為がバレたファンが言い訳したことから。</li><li><strong>平和族/変態族：</strong>変態的な発言をするファンは「変態族」と呼ばれる。</li><li><strong>男の子紫：</strong>動画内で「僕は男の子だよ」と反論したことから。</li><li><strong>×重紫：</strong>配信の人気ランキング順位＝×重紫。</li></ul>",
        btn_back: "← 戻る",
        site_p1: "こんにちは！このサイトはファンが愛を込めて自主的に作成した<strong>非公式の個人サイト</strong>です。", 
        site_h1: "制作のきっかけ", 
        site_p2: "2026年1月13日から紫先生を応援し始め、仕事への真面目さやファンへの誠実さに感動してこのサイトを作りました。", 
        site_h2: "情報源とご意見について", 
        site_p3: "当サイトの一部は萌娘百科および九重紫さんのBilibili個人ページから引用しています。", 
        site_box: "<strong>⚠️ 著作権および免責事項</strong><br><br>1. 当サイトで使用している<strong>すべてのイラスト等の著作権は、九重紫様および絵師様に帰属します。</strong><br>2. 当サイトは非営利目的のファンサイトです。"
    }
};
